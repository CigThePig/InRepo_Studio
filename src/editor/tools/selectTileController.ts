...
const LOG_PREFIX = '[SelectTool/Tiles]';

export interface SelectTileControllerConfig {
...
export interface SelectTileController {
...
export function createSelectTileController(config: SelectTileControllerConfig): SelectTileController {
  const {
    getEditorState,
    getScene,
    onSceneChange,
  ...
  return {
    ...
    handleLongPress(
      ...
      if (selection) {
        startMoveInternal(screenX, screenY, viewport, tileSize);
      }
    },
